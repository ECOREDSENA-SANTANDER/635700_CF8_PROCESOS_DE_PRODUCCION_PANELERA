...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-4.col-md-8.col-9.mb-3.mb-lg-0(data-aos="fade-right")
        img(src="@/assets/curso/temas/tema3/img3-1.png", alt="")
    ...
    TabsC.color-acento-contenido.mb-5(data-aos="fade-down")
      .py-4.py-md-5(titulo="Empaque para la distribución a nivel nacional")
        .row.justify-content-center.align-items-center
          .col-md-4.col-9.mb-4.mb-md-0
            img(src="@/assets/curso/temas/tema3/img3-2.png", alt="")
          .col-md-6
      ...
      .py-4.py-md-5(titulo="Empaque y embalaje de la panela para exportar")
        .row.justify-content-center
          .col-md-4.col-9.mb-4.mb-md-0
            img(src="@/assets/curso/temas/tema3/img3-3.png", alt="")
          .col-md-6
    ...
    p.mb-4 El video que se presenta a continuación, ilustra los principales materiales utilizados en el proceso de la panela y el tipo de empaque empleado, por lo tanto, lo invitamos a observar con atención:
    ...
    figcaption Video. Principales materiales utilizados en el proceso de la panela
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-2.col-6.mb-3.mb-lg-0(data-aos="fade-right")
        img(src="@/assets/curso/temas/tema3/img3-4.svg", alt="")
    ...
    .row.justify-content-center.mb-5
      .col-lg-8.col-sm-8
        ...
        ImagenInfografica.color-primario(data-aos="fade-down")
          template(v-slot:imagen)
            figure
              img(src='@/assets/curso/temas/tema3/img3-5.svg', alt='')
          .tarjeta.cftpc1.p-3(x="20%" y="8%" numero="")
            p.mb-0 Apilar ordenadamente o en tarimas con un buen espacio libre entre paredes y pisos.
          .tarjeta.cftpc1.p-3(x="9%" y="34%" numero="")
            p.mb-0 El almacenamiento debe realizarse en condiciones apropiadas de temperatura, humedad y circulación de aire.
          .tarjeta.cftpc1.p-3(x="9%" y="59%" numero="")
            p.mb-0 Debe llevarse un control de primeras entradas y salidas con el fin de garantizar la rotación de los productos. A veces, las empresas necesitan deshacerse de productos y equipos obsoletos e inutilizables para ayudar a limpiar los nuevos y así eliminar la posible contaminación.
          .tarjeta.cftpc1.p-3(x="20%" y="84%" numero="")
            p.mb-0 Los materiales y productos terminados se almacenan de manera que se minimicen los daños y se protejan contra condiciones que puedan afectar su limpieza, función e integridad. Además, deben estar claramente identificados para comprender su origen, calidad y vida útil.
          .tarjeta.cftpc2.p-3(x="76%" y="8%" numero="")
            p.mb-0 El almacenamiento de materias primas o productos terminados, debe organizarse en cajas o tarimas a una distancia mínima de 60 cm de las paredes y sobre tarimas a 15 cm del suelo, de manera que se pueda realizar la inspección, limpieza y fumigación en la medida de lo posible. No utilice aquellas que estén sucias o dañadas.
          .tarjeta.cftpc2.p-3(x="88%" y="34%" numero="")
            p.mb-0 En los lugares o áreas destinadas al almacenamiento de materiales y productos terminados, no se podrá realizar ningún otro trabajo, salvo el mencionado.
          .tarjeta.cftpc2.p-3(x="88%" y="59%" numero="")
            p.mb-0 Los alimentos devueltos a la empresa por caducidad deberán conservarse en una habitación o despensa únicamente para este fin; dicho depósito deberá estar claramente identificado, y se llevará un libro de caja en el que se hará constar la fecha y el importe de las mercancías devueltas, la parte enviada y el destino. Estos registros serán trasladados a la autoridad sanitaria competente.
          .tarjeta.cftpc2.p-3(x="76%" y="84%" numero="")
            p.mb-0 Los pesticidas, detergentes, desinfectantes y otros materiales peligrosos que se encuentren en el área por la necesidad de su uso deben estar etiquetados con información sobre el tóxico y cómo usarlo. Estos productos deben ser almacenados en áreas designadas o en estantes y manipulados únicamente por personal calificado para evitar la contaminación de otros productos.
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-2.col-7.mb-3.mb-lg-0(data-aos="fade-right")
        img(src='@/assets/curso/temas/tema3/img3-7.svg', alt='')
      .col-lg-10(data-aos="fade-left")
    ...
    .row.justify-content-center.mb-5
      .col-lg-10.col-sm-9    
        ImagenInfografica.color-primario
          template(v-slot:imagen)
            figure
              img(src='@/assets/curso/temas/tema3/img3-8.svg', alt='')
          .tarjeta.cftpc1.p-3(x="14%" y="77%" numero="")
            p.mb-0 Comienza externamente en la panela y avanza hasta invadir totalmente, acentuándose cuando el producto se fracciona debido a una mayor área de exposición.
          .tarjeta.cftpc2.p-3(x="50%" y="77%" numero="")
            p.mb-0 El tono claro vuelve al verdoso, que había sido eliminado por el Na2S2O4, debido al paso del complejo ferroso a férri­co por oxidación al con­tacto con el aire. Así mismo, aún en panela sin aditivos químicos se presenta oscurecimiento del producto por acción de la luz.
          .tarjeta.cftpc1.p-3(x="86%" y="77%" numero="")
            p.mb-0 Sobre la superficie se presenta invasión de hongos, levaduras y bacterias.
    ...
    p El 28 de septiembre de 2011 fue el último día para que la industria panelera colombiana comenzará a cumplir con los requisitos establecidos en el Decreto 779, del 17 de marzo de 2006, así como la información contenida en el Decreto 4121, del 16 de septiembre de 2011, emitido por el Departamento de Seguridad Social.
    p.mb-4 A continuación, se presentan algunas de las precisiones que deben ser contempladas para el empaque y embalaje de la panela en Colombia.
    ...
    .row.justify-content-center.mb-5
      ...
      .col-lg-4.d-none.d-lg-block.mb-sm-4(data-aos="fade-left")
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-2.col-6.mb-sm-4
        img(src='@/assets/curso/temas/tema3/img3-10.svg', alt='')
      .col-lg-10
    ...
    TabsC.color-acento-contenido.mb-5
      .py-4.py-md-5.cftaba.tarjeta(titulo="Asepsia y empaques")
        .row.justify-content-center.align-items-center
          .col-lg-2.col-sm-3.col-5.mb-3.mb-lg-0
            img(src='@/assets/curso/temas/tema3/img3-11.svg', alt='')
          .col-lg-8.col-sm-8
      ...
      .py-4.py-md-5.tarjeta.cftaba.p-4(titulo="Fluctuación de precios")
        .row.justify-content-center.align-items-center
          .col-lg-2.col-sm-3.col-5.mb-3.mb-lg-0
            img(src='@/assets/curso/temas/tema3/img3-12.svg', alt='')
          .col-lg-8.col-sm-8
      ...
      .py-4.py-md-5.tarjeta.cftaba.p-4(titulo="Utilización de azúcar en la fabricación")
        .row.justify-content-center.align-items-center
          .col-lg-2.col-sm-3.col-5.mb-3.mb-lg-0
            img(src='@/assets/curso/temas/tema3/img3-13.svg', alt='')
          .col-lg-8.col-sm-8
      ...
      .py-4.py-md-5.tarjeta.cftaba.p-4(titulo="Deficiencias")
        .row.justify-content-center.align-items-center
          .col-lg-2.col-sm-3.col-5.mb-3.mb-lg-0
            img(src='@/assets/curso/temas/tema3/img3-14.svg', alt='')
          .col-lg-8.col-sm-8
