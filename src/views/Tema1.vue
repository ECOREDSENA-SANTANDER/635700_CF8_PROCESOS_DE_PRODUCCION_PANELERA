  ...
  .curso-main-container.pb-3
    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .row.justify-content-center.align-items-center.mb-5
        ...
        .col-lg-4.col-md-8.col-8.order-sm-first.order-lg-last.mb-sm-4
          figure
      ...
      .row.justify-content-center.align-items-center.mb-5
        .col-lg-2.col-md-8.col-8.mb-sm-4(data-aos="fade-right")
          figure
      ...
      .row.justify-content-center.align-items-center.mb-5
        ...
        .col-lg-4.col-md-8.col-7.order-sm-first.order-lg-last.mb-sm-4(data-aos="fade-left")
          figure
      ...
      .row.justify-content-center.align-items-center.mb-5
        .col-lg-2.col-sm-5.mb-3(data-aos="fade-right")
          figure
      ...
      .row.justify-content-center.align-items-center.mb-5
        .col-lg-5.col-md-8.col-7.mb-sm-4(data-aos="fade-right")
          figure
      ...
      TabsC.color-acento-contenido.mb-5(data-aos="zoom-in")
        .py-4.py-md-5(titulo="Instalaciones físicas")
          .row.justify-content-center.align-items-center
            .col-md-4.col-lg-4.col-8.mb-4.mb-md-0
              figure
                img.mb-4(src='@/assets/curso/temas/tema1/img1-16.png' alt='Instalaciones físicas')
            .col-lg-6
              ul
                li
        ...
        .py-4.py-md-5(titulo="Instalaciones sanitarias")
          .row.justify-content-center.align-items-center
            .col-md-4.col-lg-4.col-8.mb-4.mb-md-0
              figure
                img.mb-4(src='@/assets/curso/temas/tema1/img1-17.png' alt='Instalaciones sanitarias')
            .col-lg-6
        ...
        .py-4.py-md-5(titulo="Personal manipulador de alimentos")
          .row.justify-content-center.align-items-center
            .col-md-4.col-lg-4.col-8.mb-4.mb-md-0
              figure
                img.mb-4(src='@/assets/curso/temas/tema1/img1-18.png' alt='Personal manipulador de alimentos')
            .col-lg-6
              ul
                li
                  i.fas.fa-circle.fa-xs.cs.me-3
